...
const NavBar = () => {
	...
	return (
		<nav className="border-b-[1px] border-[#213B86]  dark:border-[#222222] pb-4 borderNone">
			<div className="flex items-center justify-between dark:text-[#222222] text-[#213B86]">
				<Link href="/">
				...
				<div className="rightPart flex items-center gap-5 z">
					<div id="toggle-darkmode-container" className="w-11 h-5 ">
						...
						>
							...
							<span className="w-3 h-3 mt-[-1px] rounded-full bg-[#213B86] dark:bg-[#222222] block float-right dark:float-left"></span>
							<span className="hidden dark:inline">
								<svg
									...
									fill="none"
									xmlns="http://www.w3.org/2000/svg"
									className="fill-[#222222] mr-[0.10rem]"
								>
									<path
										fill-rule="evenodd"
										clip-rule="evenodd"
